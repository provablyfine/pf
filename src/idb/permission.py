...
class Converter:
    ...
    def convert(self, permissions: list[permission_schema.Grant]) -> dict:
...
serializer = (Converter()
    ...
    .add_object_field(object='identity', from_name='created_by_id', to_name='created_by', table=_read_identity_by_id, convert=lambda o: o.name)
    .add_action_field(object='identity', from_name='tag_id', to_name='tag', table=_read_tag_by_id, convert=_tag_to_str)
)
...
deserializer = (Converter()
    ...
    .add_object_field(object='identity', from_name='created_by_id', to_name='created_by', table=_read_identity_by_name, convert=lambda o: o.id)
    .add_action_field(object='identity', from_name='tag_id', to_name='tag', table=_read_tag_by_name_value, convert=lambda o: o.id)
)
