...
def add_subparsers(parser):
    ...
    download_host_signing_key_parser = subparsers.add_parser('get-host-signing-key', help='Download the host signing key')
    ...
    download_user_signing_key_parser = subparsers.add_parser('get-user-signing-key', help='Download the user signing key')
    ...
    ssh_agent_cli.add_subparsers(agent_parser)
