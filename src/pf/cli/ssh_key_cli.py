...
def add_subparsers(parser):
    ...
    generate_parser.add_argument(
        "-t",
        "--type",
        choices=["ed25519", "ecdsa", "ecdsa-256", "ecdsa-384", "ecdsa-521", "rsa", "rsa-3072", "rsa-7680", "rsa-15360"],
        default="ed25519",
        help="Type of key to generate. ecdsa=ecdsa-256 and rsa=rsa-3072. Default: %(default)s.",
    )
    generate_parser.add_argument(
        "-f", "--format", choices=["openssh", "pem"], help="Output format. Default: %(default)s", default="pem"
    )
    ...
    convert_parser.add_argument(
        "--to", choices=["openssh", "pem"], help="Output format. Default: %(default)s", default="openssh"
    )
    ...
    public_parser.add_argument(
        "--format", choices=["openssh", "pem"], help="Output format. Default: %(default)s", default="openssh"
    )
